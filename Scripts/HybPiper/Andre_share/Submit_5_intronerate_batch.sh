...
#SBATCH --array=1-95 #This is the number of hybpiper directories in HybPiperOuts/
...
#Naming
file= $(ls HybPiperOuts/RAPiD-Genomics_F078_UFL_394804_P0* |head -n $SLURM_ARRAY_TASK_ID|tail -n 1)
